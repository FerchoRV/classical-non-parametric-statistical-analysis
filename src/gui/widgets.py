...
class DataFrameTable(ctk.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.tree = ttk.Treeview(self, show="headings", style="Datos.Treeview")
    ...
    def _style_treeview(self) -> None:
        ...
        style.map("Datos.Treeview.Heading", background=[("active", config.COLOR_PRIMARY_HOVER)])
